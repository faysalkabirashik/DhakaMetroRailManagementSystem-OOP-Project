 ...
 */
public class CountryCityAreaEtcAddressList implements Serializable {
    ...
    {
        if (CountryCityAreaEtcAddressList.countries.isEmpty())
        {
            countries = CountryCityAreaEtcAddressList.getInitialCountries();
            return countries;
        }
        else{
            return countries;
    ...
    public static void setCountries(List<String> countries) 
        {
        CountryCityAreaEtcAddressList.countries = countries;
        }
...
/*
    ...
    public static void setBdCities(List<String> bdCities) {
        CountryCityAreaEtcAddressList.bdCities = bdCities;
        }



    public static void setBdDistricts(List<String> bdDistricts) {
        CountryCityAreaEtcAddressList.bdDistricts = bdDistricts;
        }



    public static void setBdDivisions(List<String> bdDivisions) {
        CountryCityAreaEtcAddressList.bdDivisions = bdDivisions;
    }
...
*/
    ...
    public static void setMapDhaka(Map<String, List<String>> mapDhaka) {
        CountryCityAreaEtcAddressList.mapDhaka = mapDhaka;
    }
    ...
    public static void setMapMymensingh(Map<String, List<String>> mapMymensingh) {
        CountryCityAreaEtcAddressList.mapMymensingh = mapMymensingh;
    }
    ...
    public static void setMapRajshahi(Map<String, List<String>> mapRajshahi) {
        CountryCityAreaEtcAddressList.mapRajshahi = mapRajshahi;
    }
    ...
    public static void setMapRangpur(Map<String, List<String>> mapRangpur) {
        CountryCityAreaEtcAddressList.mapRangpur = mapRangpur;
    }
    ...
    public static void setMapSylhet(Map<String, List<String>> mapSylhet) {
        CountryCityAreaEtcAddressList.mapSylhet = mapSylhet;
    }
    ...
    public static void setMapKhulna(Map<String, List<String>> mapKhulna) {
        CountryCityAreaEtcAddressList.mapKhulna = mapKhulna;
    }
    ...
    public static void setMapChittagong(Map<String, List<String>> mapChittagong) {
        CountryCityAreaEtcAddressList.mapChittagong = mapChittagong;
    }
    ...
    public static void setMapBarisal(Map<String, List<String>> mapBarisal) {
        CountryCityAreaEtcAddressList.mapBarisal = mapBarisal;
    }
