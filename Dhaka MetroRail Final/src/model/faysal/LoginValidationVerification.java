 ...
 */
public final class LoginValidationVerification {
    ...
    public static final boolean validationProcessOfData( String emailOrId, String pass, Label emailErrorLabel,
        ...
        if ( emailOrId.length() > 6 ){
            if (LoginValidationVerification.isValidEmail(emailOrId)){
            ...
            if (LoginValidationVerification.isValidId(emailOrId)){
                emailErrorLabel.setVisible(false);
                emailOrIdTextField.setStyle("-fx-border-color: transparent;");
            }
            else{
        ...
        if ( LoginValidationVerification.isValidPassword(pass) ){
